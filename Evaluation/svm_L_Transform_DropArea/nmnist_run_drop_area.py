...
def main():
    ...
    prob_list = np.linspace(0,0.9,10)

    for ratioZ in prob_list: 

        this_prop=int(ratioZ*100)
        ...
        '''TRANSFORM'''
        transform = tonic.transforms.DropEventByArea(sensor_size=data_test.sensor_size, area_ratio=float(ratioZ))
